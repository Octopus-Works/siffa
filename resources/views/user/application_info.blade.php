                            ...
                            <ul class="stepper horizontal" id="horizontal-stepper" style="height:1300px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="md-form col-12 ml-auto">
                                                <textarea id="branches-address" name="branches_address"
                                                    ...
                                                    rows="3"> {{$user->shippingOffice->addresses}} </textarea>
                                                <label for="branches-address">Addresses of Branches</label>
                                            </div>
                                            <div class="md-form col-12 ml-auto">
                                                <input id="type" name="shipping_services"
                                                    value="{{$user->shippingOffice->shipping_services}}" type="text"
                                                    class="validate form-control" required>
                                            ...
                                            <div class="md-form col-12 ml-auto">
                                                <input id="regist-num" name="commercial_registry"
                                                    value="{{$user->shippingOffice->commerical_registry}}" type="text"
                                                    class="validate form-control" required>
                                            ...
                                            <div class="md-form col-12 ml-auto">
                                                ...
                                                <div class="custom-control custom-checkbox ml-4">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="method1"
                                                        name="shipping_methods[]" value="LTL" @if(in_array("LTL", $chk))
                                                        checked @endif>
                                                ...
                                                <div class="custom-control custom-checkbox ml-4">
                                                    <input type="checkbox" class="custom-control-input" id="method2"
                                                        name="shipping_methods[]" value="FTL" @if(in_array("FTL", $chk))
                                                        checked @endif>
                                            ...
                                            <div class="md-form col-12 ml-auto">
                                                ...
                                                <div class="custom-control custom-checkbox ml-4">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="mode1"
                                                        name="shipping_modes[]" value="Wild" @if(in_array("Wild",
                                                        $chk1)) checked @endif>
                                                    <label class="custom-control-label"
                                                        for="mode1">LandTransport</label>
                                                </div>
                                                <div class="custom-control custom-checkbox ml-4">
                                                    <input type="checkbox" class="custom-control-input" id="mode2"
                                                        name="shipping_modes[]" value="Aerial" @if(in_array("Aerial",
                                                        $chk1)) checked @endif>
                                                ...
                                                <div class="custom-control custom-checkbox ml-4">
                                                    ...
                                                    <label class="custom-control-label"
                                                        for="mode3">WaterTransport</label>
                                                </div>
                                            </div>
                                            <div class="md-form col-12 ml-auto">
                                                <input id="src-dest" name="src_dest"
                                                    value="{{$user->shippingService->sources_destinations}}" type="text"
                                                    class="validate form-control" required>
                                ...
                                <li class="step">
                                    ...
                                    <div class="step-new-content">
                                        ...
                                        <div class="row">
                                            <div class="md-form col-12 ml-auto">
                                                <input id="financial-status" name="financial_status"
                                                    value="{{$user->applicationDetail->Financial_assignment_status}}"
                                                    type="text" class="validate form-control" required>
                                        ...
                                        <div class="row">
                                            <div class="md-form col-12 ml-auto">
                                                <textarea id="resume-info" name="resume_info"
                                                    class="md-textarea form-control"
                                                    rows="3"> {{$user->applicationDetail->Resume_information}} </textarea>
                                                <label for="resume-info">Resume Inofrmation (As Mentioned in the
                                                    Application Document)</label>
                                            </div>
                                            <div class="step-actions d-flex justify-content-center">
                                                <button
                                                    class="waves-effect waves-dark btn btn-large btn-amber next-step"
