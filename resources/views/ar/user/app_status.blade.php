                    ...
                    <div class="col-md-12 mb-12">
                        ...
                        <div class="card card-cascade narrower custom-primary mb-4">
                            ...
                            <div
                                ...
                                <a href="" class="white-text mx-3">الحالة</a>
                            ...
                            <div class="modal-body" style="height:800px">
                                <div class="card custom-primary" style="height:800px">
                                    <div class="card-body p-5 mt-5 text-center">
                                        ...
                                        <h3 class="h3-responsive"> :حالة طلب التسجيل <!-- Change the badges --> 
                                            ...
                                            @if(isset($temp) && $temp == "مرفوض") badge badge-danger @endif
                                            @if(isset($temp) && $temp == "مقبول بانتظار إشعار الدفع") badge badge-primary @endif
                                            @if(isset($temp) && $temp === "مدفوع قيد التسجيل") badge badge-primary @endif
                                            @if(isset($temp) && $temp == "تسجيل") badge badge-success @endif '>
                                    ...
                                    <div>
                                        <div>
                                            @if(isset($temp) && $temp == "مقبول بانتظار إشعار الدفع")
                                            <i class="fas fa-angle-double-down fa-2x custom-tertiary-text m-5"></i>
                                                <button type="button" id="new" class="btn custom-secondary btn-rounded  p-3" data-toggle='modal' data-target='#payment_details'>ارسل إشعار الدفع<i class="fas fa-paper-plane ml-2"></i>
                                                </button>
                                            @endif
                                        </div>
                                    </div>
