        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                var columnDefs = [{
                    ...
                    {
                        responsivePriority: 1, title: "<h5 class='font-weight-bold custom-secondary-text'>الاسم الكامل</h5>"
                    },
                    {
                        responsivePriority: 4, title: "<h5 class='font-weight-bold custom-secondary-text'>اسم الأب</h5>"
                    },
                    {
