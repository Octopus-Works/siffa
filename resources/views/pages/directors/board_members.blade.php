            ...
            <section class="team-section pb-5 mb-4">
                    ...
                    <div class="row mb-lg-4 text-center text-md-left">
                      ...
                      <div class="col-lg-6 col-md-12 mb-5">
                        ...
                        <div class="col-md-6 float-left">
                          <div class="avatar mx-auto white mb-md-0 mb-4">
                            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(32).jpg" class="rounded z-depth-1"
                      ...
                      <div class="col-lg-6 col-md-12 mb-5">
                        ...
                        <div class="col-md-6 float-left">
                          <div class="avatar mx-auto white mb-md-0 mb-4">
                            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(20).jpg" class="rounded z-depth-1"
                    ...
                    <div class="row text-center text-md-left">
                      ...
                      <div class="col-lg-6 col-md-12 mb-5">
                        ...
                        <div class="col-md-6 float-left">
                          <div class="avatar mx-auto white mb-md-0 mb-4">
                            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(26).jpg" class="rounded z-depth-1"
                      ...
                      <div class="col-lg-6 col-md-12 mb-5">
                        <div class="col-md-6 float-left">
                          <div class="avatar mx-auto white mb-md-0 mb-4">
                            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(29).jpg" class="rounded z-depth-1"
                ...
                <!-- Streak -->
                <div class="streak streak-photo streak-md" style="background-image: url('{{url('img/7.jpg')}}');">
                  <div class="flex-center mask rgba-gradient">
                    <div class="container my-5">
            
                      <!-- Section: Testimonials v.2 -->
                      <section class="text-center white-text pb-5">
            
                        <!-- Section heading -->
                        <h1 class="font-weight-bold white-text h1 py-5">Directors</h1>
                        <!-- Section description -->
                            ...
                            <div class="carousel-inner" role="listbox">
                              ...
                              <div class="carousel-item active">
                                ...
                                <div class="testimonial">
                                  ...
                                  <!-- Content -->
                                  <p class="white-text">
                                    <i class="fas fa-quote-left white-text"></i> Lorem ipsum dolor sit amet, consectetur
                                    adipisicing
                                    elit. Quod eos id officiis
                                    hic tenetur quae quaerat ad velit ab. Lorem ipsum dolor sit amet, consectetur
                              ...
                              <div class="carousel-item">
                                ...
                                <div class="testimonial">
                                  ...
                                  <!-- Content -->
                                  <p class="white-text">
                                    <i class="fas fa-quote-left white-text"></i> Nemo enim ipsam voluptatem quia voluptas sit
                              ...
                              <div class="carousel-item">
                                ...
                                <div class="testimonial">
                                  ...
                                  <!-- Content -->
                                  <p class="white-text">
                                    <i class="fas fa-quote-left white-text"></i> Duis aute irure dolor in reprehenderit in
                                    voluptate
