...
<body class="fixed-sn ">
  ...
  <main class="">
        ...
        <div class="modal fade" id="modalConfirmBlock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          aria-hidden="true">
          <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
            <!--Content-->
            <div class="modal-content text-center">
              ...
              <!--Footer-->
              <div class="modal-footer flex-center">
                <a type="button" id="yes-button-block" class="btn  btn-outline-danger" data-dismiss="modal">Yes</a>
                <a type="button" id="no-button" class="btn  btn-danger waves-effect" data-dismiss="modal">No</a>
              </div>
            </div>
            <!--/.Content-->
        ...
        <!--Modal: modalConfirmDelete-->
            ...
            <!--Modal: modalConfirmDelete-->
            <div class="modal fade" id="modalConfirmUnblock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-sm modal-notify modal-success" role="document">
              ...
              <div class="modal-content text-center">
                ...
                <!--Footer-->
                <div class="modal-footer flex-center">
                  <a type="button" id="yes-button-unblock" class="btn  btn-outline-success" data-dismiss="modal">Yes</a>
                  <a type="button" id="no-button" class="btn  btn-success waves-effect" data-dismiss="modal">No</a>
                </div>
              </div>
              <!--/.Content-->
            </div>
