...
<body class="creative-lp">
    ...
    <main>
        ...
        <section class="mt-3 mb-2 pt-5 pb-2 container">
                ...
                <!-- Section heading -->
                <h3 class="text-center title my-2 pt-2 pb-2 dark-grey-text font-weight-bold wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
                    ...
                    <div class="col-md-12 mb-2 text-center">
                        ...
                        <div class="text-left">
                            ...
                            <p class="grey-text font-weight-bold mx-2">
                                “Company” is the SFFA member trading under these Conditions and this expression includes any parent subsidiary or affiliated company of the Company.
                                    ...
                                    <div class="col-md-12 mb-2 text-center">
                                        ...
                                        <div class="text-left">
                                            ...
                                            <p class="grey-text font-weight-bold mx-2">
                                                    ...
                                                    c.If any legislation is compulsorily applicable to any business undertaken, these Conditions, shall as regards such business, be read as subject to such legislation and nothing in these Conditions shall be construed as a surrender by the Company of any of its rights or immunities or as an increase of any of its responsibilities or liabilities under such legislation to any extent such part shall as regards such business be overridden to that extent and no further.
                                            </p>
                                        </div>
                                        <!--/.Panel-->
                ...
                <div class="row wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.4s;">
                        ...
                        <div class="col-md-12 mb-2 text-center">
                            ...
                            <div class="text-left">
                                ...
                                <p class="grey-text font-weight-bold mx-2">
                                        The Customer warrants that he is either the Owner or the authorised agent of the Owner and also that he has authority to accept these Conditions not only for himself but also as agent for and on behalf of the Owner.                                </p>
                            </div>
                            <!--/.Panel-->
                ...
                <div class="row wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.4s;">
                        ...
                        <div class="col-md-12 mb-2 text-center">
                            ...
                            <div class="text-left">
                                ...
                                <p class="grey-text font-weight-bold mx-2">
                                        In authorizing the Customer to enter into any contract with the company and/or in accepting any document issued by the company in connection with such Contract, the Owner irrevocably accepts these Conditions for themselves and their agents and for any parties on whose behalf they or their agents may act, and in particular but without prejudice to the generality of this Clause, they accept that the Company shall have the right to enforce against them jointly and severally any liability of the Customer under these Conditions or to recover from them any sums to be paid to the Company by the Customer which upon proper demand have not been paid.                            </div>
                            <!--/.Panel-->
                ...
                <div class="row wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.4s;">
                        ...
                        <div class="col-md-12 mb-2 text-center">
                            ...
                            <div class="text-left">
                                ...
                                <p class="grey-text font-weight-bold mx-2">
                                        a. Subject to Clauses 13 and 14 below, the Company shall be entitled to procure any or all of its services as an agent or to provide these services  as a principal.
                                        ...
                                        c. When acting as an agent the Company does not make or purport to make any contract with the Customer for the carriage, storage, packing or handling of any goods nor for any other physical service in relation to them and acts solely on behalf of the Customer in securing services by establishing Contracts with third parties so that direct contractual relationships are established between the Customer and such third parties.
                                         d. The Company shall on demand by the Customer provide evidence of any Contract entered into as agent for the Customer. Insofar as the Company may be in default of this obligation, it shall be deemed to have contracted with the Customer as a principal for the performance of the Customer’s instructions.                            </div>
                            <!--/.Panel-->
